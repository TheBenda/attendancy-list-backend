...
internal static class RefreshEndpoint
{
    ...
    {
        endpoints.MapPost("/refresh",
                async (RefreshRequest refreshRequest, UserManager<ApplicationUser> userManager,
                    IRefreshTokenRepository repository, TokenProvider tokenProvider, CancellationToken ct) =>
                {
