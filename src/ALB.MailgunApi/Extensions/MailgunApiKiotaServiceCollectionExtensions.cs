...
internal static class MailgunApiKiotaServiceCollectionExtensions
{
    /// <summary>
    ...
    /// </remarks>
    internal static IHttpClientBuilder AttachKiotaHandlers(this IHttpClientBuilder builder)
    {
        // Dynamically load the Kiota handlers from the Client Factory
        var kiotaHandlers = KiotaClientFactory.GetDefaultHandlerTypes();
