...
- Kubernetes cluster
- Container-registry
- Install Gateway Api: https://gateway-api.org/docs/install/ ('kubectl apply -f https://github.com/kubernetes-sigs/gateway-api/releases/download/v1.5.1/standard-install.yaml' -  verfify by running 'kubectl get crds | grep gateway')
